...
<div className="col-lg-4">
        <div className="card">
          <div className="card-body">
            ...
            <hr />
            <ul className="fa-ul">
              <li><span className="fa-li"><i className="fa fa-check"></i></span><strong>Unlimited Users</strong>
              </li>
              ...
              <li><span className="fa-li"><i className="fa fa-check"></i></span><strong>Unlimited</strong> Free
                Subdomains</li>
